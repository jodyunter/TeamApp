...
namespace TeamApp.Test.Domain.Competitions.Playoffs
{
    public class PlayoffTests
    {
        public static IEnumerable<object[]> PlayoffDataForGetTeamByRuleTests()
        {
            ...
            yield return new object[] { 1, playoff, new PlayoffSeriesRule(config, "Series 1", 1, BEST_OF_SERIES, 4, gameRules, FROM_SERIES, "Series A", GET_WINNER, FROM_SERIES, "Series A", GET_LOSER, 1, null, new int[] { 0, 0, 0, 1, 1, 1 }, null, null, null, null), "Team A1", "Team B1" };
