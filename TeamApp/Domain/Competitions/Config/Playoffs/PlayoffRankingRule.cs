namespace TeamApp.Domain.Competitions.Config.Playoffs
{
    public class PlayoffRankingRule:BaseDataObject,ITimePeriod
    {
        ...
        public virtual int DestinationFirstRank { get; set; } //this will assign this rank first when sorting.
        ...
        public PlayoffRankingRule(PlayoffCompetitionConfig config, string groupName, string sourceGroupName, string rankingGroupName, int sourceFirstRank, int? sourceLastRank, int destinationFirstRank, int groupLevel, int? firstYear, int? lastYear)
        {
