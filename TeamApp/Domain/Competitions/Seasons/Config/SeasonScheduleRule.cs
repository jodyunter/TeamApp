namespace TeamApp.Domain.Competitions.Seasons.Config
{
    public class SeasonScheduleRule:BaseDataObject,ITimePeriod
    {
        ...
        public SeasonScheduleRule(SeasonCompetitionConfig competition, Team homeTeam, SeasonDivisionRule homeDivision, Team awayTeam, SeasonDivisionRule awayDivision, int iterations, bool homeAndAway, int? firstYear, int? lastYear)
        {
